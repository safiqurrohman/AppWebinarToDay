<template>
  <div class="wrapper w-80">
    ...
    <form class="p-3 mt-3 flex" @submit.prevent="register">
      ...
      <div class="form-field d-flex align-items-center">
        <span class="fas fa-key"></span>
        <input v-model="noTelp" type="text" name="nomorTelp" id="nomorTelp" placeholder="Nomor Telepon">
      </div>
      <div class="form-field d-flex align-items-center">
        <span class="fas fa-key"></span>
      ...
      <div class="form-field d-flex align-items-center">
        <span class="fas fa-key"></span>
        <input v-model="konfirmasiPassword" type="password" name="konfirmasiPassword" id="konfirmasiPassword" placeholder="Konfirmasi Password">
      </div>
